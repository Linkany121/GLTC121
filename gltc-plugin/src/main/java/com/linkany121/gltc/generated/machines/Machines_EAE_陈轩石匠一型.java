...
import com.linkany121.gltc.generated.items.Items_EAE_陈轩石匠一型;
...
public final class Machines_EAE_陈轩石匠一型 {
    private Machines_EAE_陈轩石匠一型() {}
    public static void register(SlimefunAddon addon) {
        GltcRecipeMachine machine = GltcRecipeMachine.create(
            GltcItemGroups.A_F2,
            GltcItemBuilder.slimefunStack("EAE_陈轩石匠一型", Items_EAE_陈轩石匠一型.DATA),
