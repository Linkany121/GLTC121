...
const CATEGORIES = [
    {
        ...
        lore: '§x§F§F§B§6§C§1❀ §x§F§F§B§6§C§1杂物与工具 §x§C§D§5§B§9§9❀',
        icon: 'POTATO',
        slot: 10
    }
];
...
const ITEM_NAMES = {
    PAPER: '纸', SUGAR: '糖', STICK: '木棍', BOWL: '碗',
    GLASS_BOTTLE: '玻璃瓶', BUCKET: '桶', WATER_BUCKET: '水桶',
    LAVA_BUCKET: '熔岩桶', MILK_BUCKET: '牛奶桶', NAME_TAG: '命名牌',
    SADDLE: '鞍', BELL: '钟', BOOK: '书', LEAD: '拴绳',
    HONEYCOMB: '蜜脾', HONEY_BOTTLE: '蜂蜜瓶', SNOWBALL: '雪球',
    CLAY_BALL: '粘土球', BRICK: '红砖', NETHER_BRICK: '下界砖',
    FLINT: '燧石', GLOWSTONE_DUST: '萤石粉', BLAZE_POWDER: '烈焰粉',
    FERMENTED_SPIDER_EYE: '发酵蛛眼', DRAGON_BREATH: '龙息',
    EXPERIENCE_BOTTLE: '附魔之瓶', FIREWORK_ROCKET: '烟花火箭'
};

const ITEMS = {
    杂物: [
        // 极大量（1→8）
        { type: 'vanilla', id: 'STICK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 5 },
        { type: 'vanilla', id: 'SNOWBALL', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 5 },
        // 大量（1→4）
        { type: 'vanilla', id: 'PAPER', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 3 },
        { type: 'vanilla', id: 'SUGAR', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 3 },
        { type: 'vanilla', id: 'BOWL', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 3 },
        { type: 'vanilla', id: 'GLASS_BOTTLE', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 3 },
        { type: 'vanilla', id: 'CLAY_BALL', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 3 },
        // 中等（1→2）
        { type: 'vanilla', id: 'BUCKET', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BOOK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BRICK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'NETHER_BRICK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'FLINT', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        // 较少（1→1）
        { type: 'vanilla', id: 'WATER_BUCKET', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'NAME_TAG', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'LEAD', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'HONEYCOMB', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'HONEY_BOTTLE', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'GLOWSTONE_DUST', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BLAZE_POWDER', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'FIREWORK_ROCKET', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        // 少量（2→1）
        { type: 'vanilla', id: 'MILK_BUCKET', price: [{ id: 'AL_A1', amount: 8 }], giveAmount: 1 },
        // 稀有/特殊（8→1 / 12→1 / 16→1）
        { type: 'vanilla', id: 'LAVA_BUCKET', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SADDLE', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BELL', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'FERMENTED_SPIDER_EYE', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'EXPERIENCE_BOTTLE', price: [{ id: 'AL_A1', amount: 48 }], giveAmount: 1 },
        { type: 'vanilla', id: 'DRAGON_BREATH', price: [{ id: 'AL_A1', amount: 64 }], giveAmount: 1 }
    ]
};
    ...
    Bukkit.getPluginManager().registerEvent(ClickEvent, listener, EventPriority.NORMAL, (l, e) => {
        try {
            ...
            if (slot === PREV_SLOT && it.getItemMeta().getDisplayName() === '§e← 上一页') {
                ...
                if (cur > 0) { PAGE_MAP.put(p, cur - 1); const inv = buildSundryMenu(cur - 1); if (inv) openMenu(p, inv); else p.sendMessage('§c无法创建兑换菜单，请联系管理员。'); }
                return;
            }
            if (slot === NEXT_SLOT && it.getItemMeta().getDisplayName() === '§e下一页 →') {
                const cur = PAGE_MAP.get(p) || 0;
                const totalPages = Math.ceil(ITEMS['杂物'].length / PAGE_SIZE);
                if (cur < totalPages - 1) { PAGE_MAP.put(p, cur + 1); const inv = buildSundryMenu(cur + 1); if (inv) openMenu(p, inv); else p.sendMessage('§c无法创建兑换菜单，请联系管理员。'); }
                return;
            }
...
function openMain(p) {
    ...
    PAGE_MAP.put(p, 0); const inv = buildSundryMenu(0); if (inv) openMenu(p, inv); else p.sendMessage('§c无法创建兑换菜单，请联系管理员。'); }

function onButtonGroupClick(player, slot, clickedItem, clickAction, guideMode) { try { openMain(player); return true; } catch (err) { player.sendMessage('§c无法打开杂物兑换菜单'); return false; } }
function onUse(e) { try { openMain(e.getPlayer()); } catch (err) { e.getPlayer().sendMessage('§c无法打开杂物兑换菜单'); } return false; }