...
import com.linkany121.gltc.generated.items.Items_skey_十一号反应炉;
...
public final class Machines_skey_十一号反应炉 {
    private Machines_skey_十一号反应炉() {}
    public static void register(SlimefunAddon addon) {
        GltcRecipeMachine machine = GltcRecipeMachine.create(
            GltcItemGroups.B_B1,
            GltcItemBuilder.slimefunStack("skey_十一号反应炉", Items_skey_十一号反应炉.DATA),
        ...
        machine.setDeferredCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("ntskey1", 1), RecipeUtil.deferredSlimefun("TSwk4", 1), RecipeUtil.deferredSlimefun("TSgj5", 1), new org.bukkit.inventory.ItemStack(org.bukkit.Material.DAYLIGHT_DETECTOR, 1), null, null, null, null, null });
        GltcMenuData.register("skey_十一号反应炉", GltcMenuData_skey_十一号反应炉.DATA);
        machine.applyMenu("skey_十一号反应炉", "&#6f7dffS&#9fa8ffe&#cfd4ffk&#ffffffy &#ffcaab十&#f9c39e一&#f3bb91号&#edb484便&#e6ad76携&#e0a669反&#da9e5c应&#d4974f炉-&eI");
