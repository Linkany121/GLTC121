...
const MAIN_TITLE = '§x§7§7§f§7§f§f协§x§6§0§f§a§d§a议§x§4§9§f§d§b§5内§x§6§3§f§f§9§3容§x§b§0§f§f§7§5：§x§f§c§f§f§5§7方块';
const SHOP_LISTENER_KEY = 'gltcEnergyShop_方块';
...
const ITEM_NAMES = {
    STONE: '石头', DIRT: '泥土', SAND: '沙子', RED_SAND: '红沙',
    GRAVEL: '沙砾', COBBLESTONE: '圆石', COBBLED_DEEPSLATE: '深板岩圆石',
    OBSIDIAN: '黑曜石', CRYING_OBSIDIAN: '哭泣的黑曜石', ICE: '冰',
    CALCITE: '方解石', TUFF: '凝灰岩', ANDESITE: '安山岩', DIORITE: '闪长岩',
    GRANITE: '花岗岩', SANDSTONE: '砂岩', RED_SANDSTONE: '红砂岩',
    NETHERRACK: '下界岩', SOUL_SAND: '灵魂沙', SOUL_SOIL: '灵魂土',
    BLACKSTONE: '黑石', BASALT: '玄武岩', END_STONE: '末地石',
    GLOWSTONE: '萤石', SEA_LANTERN: '海晶灯', MAGMA_BLOCK: '岩浆块',
    OCHRE_FROGLIGHT: '赭黄蛙明灯', VERDANT_FROGLIGHT: '翠绿蛙明灯',
    PEARLESCENT_FROGLIGHT: '珠光蛙明灯', BUDDING_AMETHYST: '紫水晶母岩',
    SCULK: '幽匿块', SCULK_CATALYST: '幽匿催发体', SCULK_SHRIEKER: '幽匿尖啸体',
    SCULK_SENSOR: '幽匿感测体', SCULK_VEIN: '幽匿脉络',
    CLAY: '粘土块', SNOW_BLOCK: '雪块',
    PACKED_ICE: '浮冰', BLUE_ICE: '蓝冰', BONE_BLOCK: '骨块',
    BOOKSHELF: '书架', TNT: 'TNT', NOTE_BLOCK: '音符盒', JUKEBOX: '唱片机',
    LODESTONE: '磁石', RESPAWN_ANCHOR: '重生锚',
    GRASS_BLOCK: '草方块', COARSE_DIRT: '砂土', DEEPSLATE: '深板岩',
    PODZOL: '灰化土', MYCELIUM: '菌丝',
    CRIMSON_NYLIUM: '绯红菌岩', WARPED_NYLIUM: '诡异菌岩',
    ROOTED_DIRT: '缠根泥土', MUD: '泥巴', MUDDY_MANGROVE_ROOTS: '沾泥的红树根',
    DRIPSTONE_BLOCK: '滴水石块', POINTED_DRIPSTONE: '滴水石锥',
    NETHER_WART_BLOCK: '下界疣块', WARPED_WART_BLOCK: '诡异疣块',
    DRIED_KELP_BLOCK: '干海带块',
    AMETHYST_BLOCK: '紫水晶块', QUARTZ_BLOCK: '石英块',
    HONEYCOMB_BLOCK: '蜜脾块', HONEY_BLOCK: '蜂蜜块', SLIME_BLOCK: '黏液块',
    GILDED_BLACKSTONE: '镶金黑石', SHROOMLIGHT: '菌光体'
};

const ITEMS = {
    方块: [
        // 常见方块（1→8）
        { type: 'vanilla', id: 'DIRT', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'GRASS_BLOCK', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'COARSE_DIRT', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'COBBLESTONE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'NETHERRACK', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'STONE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'DEEPSLATE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'SAND', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        { type: 'vanilla', id: 'COBBLED_DEEPSLATE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 2 },
        // 普通（1→4）
        { type: 'vanilla', id: 'RED_SAND', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'GRAVEL', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'ANDESITE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'DIORITE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'GRANITE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SANDSTONE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BLACKSTONE', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BASALT', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'CLAY', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SNOW_BLOCK', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'PODZOL', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'MYCELIUM', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'CRIMSON_NYLIUM', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'WARPED_NYLIUM', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'ROOTED_DIRT', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        { type: 'vanilla', id: 'MUD', price: [{ id: 'AL_A1', amount: 1 }], giveAmount: 1 },
        // 中等（1→2）
        { type: 'vanilla', id: 'RED_SANDSTONE', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'ICE', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'TUFF', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'END_STONE', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SOUL_SAND', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SOUL_SOIL', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'MAGMA_BLOCK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'PACKED_ICE', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BONE_BLOCK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'MUDDY_MANGROVE_ROOTS', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'DRIPSTONE_BLOCK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'POINTED_DRIPSTONE', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'NETHER_WART_BLOCK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'WARPED_WART_BLOCK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        { type: 'vanilla', id: 'DRIED_KELP_BLOCK', price: [{ id: 'AL_A1', amount: 2 }], giveAmount: 1 },
        // 较少（1→1）
        { type: 'vanilla', id: 'OBSIDIAN', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'GLOWSTONE', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SEA_LANTERN', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'CALCITE', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BOOKSHELF', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'TNT', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'NOTE_BLOCK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'AMETHYST_BLOCK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'QUARTZ_BLOCK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'HONEYCOMB_BLOCK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'HONEY_BLOCK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SLIME_BLOCK', price: [{ id: 'AL_A1', amount: 4 }], giveAmount: 1 },
        // 稀有/特殊（2→1 / 4→1 / 8→1 / 12→1 / 16→1）
        { type: 'vanilla', id: 'GILDED_BLACKSTONE', price: [{ id: 'AL_A1', amount: 8 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SHROOMLIGHT', price: [{ id: 'AL_A1', amount: 8 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SCULK_VEIN', price: [{ id: 'AL_A1', amount: 16 }], giveAmount: 1 },
        { type: 'vanilla', id: 'CRYING_OBSIDIAN', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BLUE_ICE', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'OCHRE_FROGLIGHT', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'VERDANT_FROGLIGHT', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'PEARLESCENT_FROGLIGHT', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'JUKEBOX', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'RESPAWN_ANCHOR', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SCULK', price: [{ id: 'AL_A1', amount: 32 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SCULK_CATALYST', price: [{ id: 'AL_A1', amount: 48 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SCULK_SHRIEKER', price: [{ id: 'AL_A1', amount: 64 }], giveAmount: 1 },
        { type: 'vanilla', id: 'SCULK_SENSOR', price: [{ id: 'AL_A1', amount: 64 }], giveAmount: 1 },
        { type: 'vanilla', id: 'BUDDING_AMETHYST', price: [{ id: 'AL_A1', amount: 48 }], giveAmount: 1 },
        { type: 'vanilla', id: 'LODESTONE', price: [{ id: 'AL_A1', amount: 48 }], giveAmount: 1 }
    ]
};
