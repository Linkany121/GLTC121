...
public final class Scripted_ATO_能源流储蓄站 {
    ...
    public static void register(SlimefunAddon addon) {
        ...
        machine.setDeferredCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("AL_A1", 1), new org.bukkit.inventory.ItemStack(org.bukkit.Material.CRAFTING_TABLE, 1), RecipeUtil.deferredSlimefun("AL_A1", 1), null, null, null, null, null, null });
