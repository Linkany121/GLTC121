...
import com.linkany121.gltc.generated.items.Items_TShc2;
...
public final class Machines_TShc2 {
    private Machines_TShc2() {}
    public static void register(SlimefunAddon addon) {
        GltcRecipeMachine machine = GltcRecipeMachine.create(
            GltcItemGroups.A_D2,
            GltcItemBuilder.slimefunStack("TShc2", Items_TShc2.DATA),
        ...
        machine.addGltcRecipe(4, java.util.List.of(new RecipeUtil.GltcInputSlot(3, RecipeUtil.deferredSlimefun("TSzjg", 8), false), new RecipeUtil.GltcInputSlot(4, RecipeUtil.deferredSlimefun("TSgj4", 1), false)), java.util.List.of(new RecipeUtil.GltcOutputSlot(39, RecipeUtil.deferredSlimefun("TSgj5", 1), 100)), false);
        ...
        machine.addGltcRecipe(4, java.util.List.of(new RecipeUtil.GltcInputSlot(3, RecipeUtil.deferredSlimefun("TStgs", 12), false), new RecipeUtil.GltcInputSlot(4, RecipeUtil.deferredSlimefun("TSxl4", 1), false)), java.util.List.of(new RecipeUtil.GltcOutputSlot(39, RecipeUtil.deferredSlimefun("TSxl5", 1), 100)), false);
        machine.setDeferredCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("ntts1", 1), RecipeUtil.deferredSlimefun("TShc1", 1), RecipeUtil.deferredSlimefun("TSwk4", 1), RecipeUtil.deferredSlimefun("TSgj4", 1), RecipeUtil.deferredSlimefun("TSxl4", 1), null, null, null, null });
        GltcMenuData.register("TShc2", GltcMenuData_TShc2.DATA);
        machine.applyMenu("TShc2", "&#d5ff7aC&#8bff9e/&#57e6caT&#38b3ffS &#94edff微型蓝硅车床&7-&eII");
