...
import com.linkany121.gltc.generated.items.Items_FD_植械突触分解机;
...
public final class Machines_FD_植械突触分解机 {
    private Machines_FD_植械突触分解机() {}
    public static void register(SlimefunAddon addon) {
        GltcRecipeMachine machine = GltcRecipeMachine.create(
            GltcItemGroups.A_H2,
            GltcItemBuilder.slimefunStack("FD_植械突触分解机", Items_FD_植械突触分解机.DATA),
        ...
        machine.setDeferredCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("ntumpv1", 1), new org.bukkit.inventory.ItemStack(org.bukkit.Material.COMPOSTER, 1), RecipeUtil.deferredSlimefun("TSgj1", 1), RecipeUtil.deferredSlimefun("TSxl1", 1), null, null, null, null, null });
        GltcMenuData.register("FD_植械突触分解机", GltcMenuData_FD_植械突触分解机.DATA);
        machine.applyMenu("FD_植械突触分解机", "&#ff40faU&#f34ffcM&#e65dfdP&#da6cffV &#acff26植&#99fd26械&#85fb26突&#72fa26触&#5ef825分&#4bf625解&#37f425机");
