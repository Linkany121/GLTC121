...
public final class Scripted_skey_舰体订单接收机 {
    ...
    public static void register(SlimefunAddon addon) {
        GltcScriptedMachine machine = GltcScriptedMachine.create(
            ...
            RecipeUtil.resolveCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("ntskey1", 1), new org.bukkit.inventory.ItemStack(org.bukkit.Material.CRAFTING_TABLE, 1), RecipeUtil.deferredSlimefun("ntskey1", 1), null, null, null, null, null, null }),
            GltcItemBuilder.slimefunStack("skey_舰体订单接收机", Items_skey_舰体订单接收机.DATA),
            100,
            0,
