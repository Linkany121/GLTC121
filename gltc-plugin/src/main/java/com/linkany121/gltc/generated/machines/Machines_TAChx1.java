...
import com.linkany121.gltc.generated.items.Items_TAChx1;
...
public final class Machines_TAChx1 {
    private Machines_TAChx1() {}
    public static void register(SlimefunAddon addon) {
        GltcRecipeMachine machine = GltcRecipeMachine.create(
            GltcItemGroups.A_C2,
            GltcItemBuilder.slimefunStack("TAChx1", Items_TAChx1.DATA),
        ...
        machine.setDeferredCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("tac2", 1), RecipeUtil.deferredSlimefun("TSwk1", 1), RecipeUtil.deferredSlimefun("TSgj1", 1), RecipeUtil.deferredSlimefun("TSxl1", 1), null, null, null, null, null });
        GltcMenuData.register("TAChx1", GltcMenuData_TAChx1.DATA);
        machine.applyMenu("TAChx1", "&dTAC &#9c81e3电&#8372d5力&#6b62c6唤&#5253b8醒&#3944aa器&7-&eI");
