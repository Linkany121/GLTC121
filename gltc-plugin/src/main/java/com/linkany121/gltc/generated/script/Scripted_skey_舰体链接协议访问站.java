...
public final class Scripted_skey_舰体链接协议访问站 {
    ...
    public static void register(SlimefunAddon addon) {
        ...
        machine.setDeferredCraftingRecipe(new Object[] { RecipeUtil.deferredSlimefun("ntskey3", 1), new org.bukkit.inventory.ItemStack(org.bukkit.Material.CRAFTING_TABLE, 1), RecipeUtil.deferredSlimefun("ntskey3", 1), null, null, null, null, null, null });
